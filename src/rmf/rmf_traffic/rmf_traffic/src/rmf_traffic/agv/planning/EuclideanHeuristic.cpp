  ...
  Storage& new_items) const
{
  ...
  // NOTE: This lightweight A* run seeds the Euclidean heuristic. Measuring the
  // time spent inside this call quantifies the pre-processing latency that
  // contributes to the overall path planning duration.
