  ...
  Storage& new_items) const -> SolutionNodePtr
{
  ...
  // NOTE: A* is also executed here to populate the cached heuristic. Timing
  // this call tells you how long the system spends estimating the cost of a
  // pickup→dropoff path before the main planner runs.
